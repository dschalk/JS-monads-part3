...
var ret = (0, _snabbdomH2['default'])('pre', { style: { color: '#AFEEEE' } }, '  var ret = function ret(v) {\n     return new Monad(v, \'anonymous\');\n  }  ');

exports['default'] = { monad: monad, monadIter: monadIter, steps: steps, dice: dice, send: send, next: next, updateNext: updateNext,
  pause: pause, pauseDemo: pauseDemo, messages1: messages1, messages2: messages2, messages3: messages3, numbers: numbers, numbers2: numbers2, numbers3: numbers3, ret: ret };
