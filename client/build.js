...
function updateCalc() {
  ...
  ret('start').bnd(function () {
    return mMZ2.block().bnd(function () {
      ...
      return mM7.ret(calc(x[0], mM8.x, x[1])).bnd(function (x) {
        return mM1.bnd(push, x).bnd(function (x) {
          return mM1.ret(x);
        }).bnd(clean).bnd(function (x) {
          return mM1.ret(x);
...
socket.onmessage = function (event) {
  ...
  switch (d2) {
    ...
    case "CB#$42":
      ...
      mMscbd.ret(scores).bnd(updateScoreboard).bnd(update);
      break;
